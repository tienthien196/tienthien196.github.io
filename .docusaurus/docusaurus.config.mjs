...
export default {
  ...
  "stylesheets": [
    {
      ...
      "type": "text/css",
      "integrity": "sha384-wvUvB2KN7pQCO+U/wS9GehG+jw/adJzi10BGSAdoo6gWQBaIj++ImQxGcH2CqkGp",
  ...
  "themeConfig": {
    ...
    "navbar": {
      ...
      "items": [
        ...
        },
        {
          "type": "search",
          "position": "right",
          "className": "nav-button search-btn"
        },
        {
    ...
    "footer": {
      ...
      "copyright": "© 2025 Docs support GM Finn. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
